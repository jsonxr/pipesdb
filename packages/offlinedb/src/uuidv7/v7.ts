...
let _seqLow: any = null;
let _seqHigh: any = null;
let _msecs = 0;

type OutputBuffer = ArrayLike<number>;
type InputBuffer = ArrayLike<number>;
interface MsecOptions {
  msecs?: number;
}
interface SeqOptions {
  seq?: number;
}
type V7Options = SeqOptions & MsecOptions;

export function v7(options?: V7Options | null | undefined): string;
export function v7(options: V7Options | null | undefined, buffer: Uint8Array, offset?: number): Uint8Array;
export function v7(options?: V7Options | null | undefined, buf?: Uint8Array, offset?: number): Uint8Array | string {
  options = options || {};
